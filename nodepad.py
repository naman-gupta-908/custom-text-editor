...
class Notepad:
    ...
    def __init__(self, **kwargs):
        ...
        # Set the window text
        self.root.title("NewFile - MyNotepad")
        ...
        self.thisHelpMenu.add_command(label="About MyNotepad",
    ...
    def __showAbout(self):
        showinfo("MyNotepad", "by gupta_naman_908")
    ...
    def __openFile(self):
        ...
        if self.file=="":
            ...
            self.root.title(os.path.basename(self.file)+" - MyNotepad")
